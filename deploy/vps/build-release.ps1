...
Copy-Item -LiteralPath (Join-Path $root 'deploy\bin\aimili-gateway-account'),(Join-Path $root 'deploy\bin\aimili'),(Join-Path $root 'deploy\bin\aimili-xui-protocol-transaction') -Destination (Join-Path $Output 'package\deploy\bin')
