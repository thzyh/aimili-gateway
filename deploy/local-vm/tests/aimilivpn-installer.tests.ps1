...
foreach ($token in @('--check', '--apply', '--installer', 'local_installer', 'MULTI_EXIT_SLOTS', 'MAX_EXIT_SLOTS', 'UI_HOST', 'AIMILI_UI_CONFIG', '127.0.0.1', 'source-commit', 'aimilivpn.service')) {
