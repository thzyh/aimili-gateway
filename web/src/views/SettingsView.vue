...
const accountLabel = computed(() => ({
  synced: '三账户已同步', reset_required: '账户等待统一重置', checking: '正在核对账户', repair_required: '账户同步需修复', incompatible: '账户同步版本不兼容',
...
.capacity-legacy{display:grid;gap:3px;padding:12px 0}.capacity-legacy strong{font-size:24px;line-height:1.2}.capacity-legacy span{font-size:12px;color:var(--muted-text)}
.capacity-value{margin:10px 0 18px}
