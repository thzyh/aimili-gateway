...
async function openOriginal(): Promise<void> {
  ...
  } catch { notice.value = '自动进入原后台失败，请改用原后台登录页手动登录。' }
  finally { busy.value = '' }
}
